# Taken from https://github.com/NotAShelf/nvf/blob/main/modules/plugins/lsp/presets/jdt-language-server.nix, but options renamed to jdtls
# and slightly modified (changed to mkEnableOption because I was having problems)
{
  config,
  lib,
  pkgs,
...
let
  ...
  cfg = config.vim.lsp.presets.jdtls;
in
{
  options.vim.lsp.presets.jdtls = {
